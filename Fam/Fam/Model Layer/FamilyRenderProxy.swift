...
class FamilyRenderProxy {
    ...
    init(_ family: Family, stopAtStep: Int? = nil) {
        ...
        guard let root = family.getFamilyMemberWithMostAncestors() else {
            return
        }
        ...
        assert(family.cacheIsValid, "Expected to have valid cache before generating ordered family members")
