...
class FamChipButton: FamUIView {
    
    private let container = FamView()
    private let button = FamControl()
    private let imageView = FamImage()
    private var onTap: (() -> Void)? = nil
    private var imageHorizontalPadding = FamDimensions.chipPaddingHorizontal
    private var imageVerticalPadding = FamDimensions.chipPaddingVertical
